		...
		<div class="col-4">
			<div class="pt-post">
				...
				<div class="pt-details">
					<div class="pt-option">
						<a data-toggle="modal" href="#addtocartModal" data-id="<?=$rs['id']?>" class="pt-addtobasket pt-addtocart tips">
							<i class="icons icon-basket"></i>
							<b><?=$lang['home']['addtocart']?></b>
						</a>
						<?php //if (db_get("restaurants", "neworders", $rs['restaurant'])): ?>
							<?php //else: ?>
								<!-- <a class="pt-addtobasket pt-addtocart tips bg-danger">
								<i class="icons icon-close"></i>
								<b><?=$lang['home']['unavailable']?></b>
							</a> -->
						<?php //endif; ?>
					</div>
