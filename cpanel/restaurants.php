				...
				<div class="tab-content">
					...
					<div class="tab-pane container" id="menu4">
						...
						<div class="form-group">
							...
							<input type="text" name="working_hours[]" value="<?php echo (isset($rs['working_hours'][1])) ? $rs['working_hours'][1] : '' ; ?>" placeholder="10:00 am - 7:00 pm">
						</div>
						<div class="form-group">
							<label><?=$lang['tuesday']?>:</label>
							<input type="text" name="working_hours[]" value="<?php echo (isset($rs['working_hours'][2])) ? $rs['working_hours'][2] : '' ; ?>" placeholder="10:00 am - 7:00 pm">
						</div>
						<div class="form-group">
							<label><?=$lang['wednesday']?>:</label>
							<input type="text" name="working_hours[]" value="<?php echo (isset($rs['working_hours'][3])) ? $rs['working_hours'][3] : '' ; ?>" placeholder="10:00 am - 7:00 pm">
						</div>
						<div class="form-group">
							<label><?=$lang['thursday']?>:</label>
							<input type="text" name="working_hours[]" value="<?php echo (isset($rs['working_hours'][4])) ? $rs['working_hours'][4] : '' ; ?>" placeholder="10:00 am - 7:00 pm">
						</div>
						<div class="form-group">
							<label><?=$lang['friday']?>:</label>
							<input type="text" name="working_hours[]" value="<?php echo (isset($rs['working_hours'][5])) ? $rs['working_hours'][5] : '' ; ?>" placeholder="10:00 am - 7:00 pm">
						</div>
						<div class="form-group">
							<label><?=$lang['saturday']?>:</label>
							<input type="text" name="working_hours[]" value="<?php echo (isset($rs['working_hours'][6])) ? $rs['working_hours'][6] : '' ; ?>" placeholder="10:00 am - 7:00 pm">
						</div>
						<div class="form-group">
							<label><?=$lang['sunday']?>:</label>
							<input type="text" name="working_hours[]" value="<?php echo (isset($rs['working_hours'][7])) ? $rs['working_hours'][7] : '' ; ?>" placeholder="10:00 am - 7:00 pm">
						</div>
					</div>
				</div>
			</div>
